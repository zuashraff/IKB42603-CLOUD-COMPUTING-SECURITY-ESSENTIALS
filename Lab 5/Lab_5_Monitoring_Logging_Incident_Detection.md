...
| --- | --- | --- |
| 1 | `Task 1.png` | Authentication log creation and contents. |
| 2 | `Task 2.png` | Event upload loop and central retrieval. |
| 3 | `Task 3.png` | Four failed attempts from the suspicious IP. |
| 4 | `Task 4.png` | Hash chain and a separately tampered log copy. |
| 5 | `Task 5.png` | Incident correlation and alert output. |
| 6 | `Task 6.png` | Drop rule plus evidence hash generation. |
